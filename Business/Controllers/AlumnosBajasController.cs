...
namespace Business.Controllers
{
    ...
    public class AlumnosBajasController : ControllerBase
    {
        ...
        public AlumnosBajasController(DBContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<AlumnosBaja>> PostAlumnosBaja(AlumnosBaja alumnosBaja)
        {
            ...
            return CreatedAtAction("GetAlumnosBaja", new { id = alumnosBaja.IdAlumno }, alumnosBaja);
        }
        ...
        {
            return _context.AlumnosBajas.Any(e => e.IdAlumno == id);
        }
    }
}
