...
namespace Business.Controllers
{
    ...
    public class MateriasController : ControllerBase
    {
        ...
        {
            // read the settigns
            string charsToRemove = new ConfigurationBuilder()
                .AddJsonFile("appsettings.json")
                .Build()
                .GetSection("AppSettings")["charsToRemove"] ?? "&<>/";
            // use regex to clean
            materia.Nombre = Regex.Replace(materia.Nombre, "[" + charsToRemove +"]", string.Empty);
